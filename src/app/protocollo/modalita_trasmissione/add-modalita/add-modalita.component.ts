...
@Component({
  selector: 'app-add-modalita',
  templateUrl: './add-modalita.component.html',
  styleUrls: ['./add-modalita.component.css']
})
export class AddModalitaComponent implements OnInit {
  id;
